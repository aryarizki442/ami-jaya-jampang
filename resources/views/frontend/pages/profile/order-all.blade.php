        ...
        <div class="card order-card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <span class="badge status-wait text-white">
                        Menunggu Pembayaran
                    </span>
                ...
                <div class="row align-items-center mb-5">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="d-flex align-items-center gap-3 order-product">
                            ...
                            <img src="{{ asset('images/payments/bank/bca.png') }}">

                            <div>
                                <div class="order-meta">Metode Pembayaran</div>
                                <strong>BCA Virtual Account</strong>
                            </div>

                            <div>
                                <div class="order-meta">Nomor Virtual Account</div>
        ...
        <div class="card order-card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-end mb-2">
                    ...
                    <span class="badge status-send text-white">
                        Dikirim
                    </span>
        ...
        <div class="card order-card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-end mb-2">
                    ...
                    <span class="badge status-cancel text-white">
                        Dibatalkan
                    </span>
